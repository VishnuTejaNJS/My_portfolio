...
ScrollReveal().reveal('.home-image, .tool, .tool-content-image, .portfolio-box, .contact form',{origin:'button'});
ScrollReveal().reveal('.home-content h1, .about-image, ',{origin:'left'});
ScrollReveal().reveal('.home-content p, .home-image img, .about-content',{origin:'right'});
